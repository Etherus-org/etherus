...
```
go get -u -d github.com/ya-enot/ethermint
go get -u -d github.com/ya-enot/tendermint
cd $GOPATH/src/github.com/ya-enot/ethermint
make install
cd ../tendermint
make install
```
...
please download these default files [here](https://github.com/ya-enot/ethermint/tree/develop/setup).
...
See the [open issues](https://github.com/ya-enot/ethermint/issues) for
